...
>The system has three activities that were proposed by occupational therapists. They were named Playing Ball, Forming Word and Summation. In general, in all three activities the patient interacts with the game by “fixing" his/her sight on a moving object 
## Measures

>initial evaluation with occupational therapists. 

>After the use period, we scheduled a time to collect the system and conduct a 2nd interview with the OTs. This interview aimed at collecting data regarding the therapists’ experience in using Imaginator in their treatments. The interview script was organized in 2 themes, containing 12 questions: the ﬁrst focused on their experience in using the system in their therapy treatment; whereas the 2nd focused on their own experience with the therapist’s interface.
## Results

>The simulator generates the sense of [[Presence]] ... the greater its intensity, the greater the chance of the user behaving within the environment similarly to how they would behave in their day-to-day physical environment 

>The system generated [[Stimuli]] in more than one sense: In general, therapists perceived that the vestibular, proprioceptive, visual, tactile and auditory senses were being stimulated. They reported that the impact on the auditory sense could be negative, while the impact on the other senses were positive.

>patients were motivated to use the system, even when it would cause them some discomfort, for instance to put on the Oculus Rift

>increase patients relaxation and improve their concentration. 

>some of the patients had some negative reaction to the use of the system (e.g. headache, nau- sea, dizziness, sweating, euphoria, agitation and exhaustion), which were of short duration and were often reactions also seen in other therapeutic equipment. ... they are also symptoms of [[Cybersickness]]

>being able to customize the system was a very important feature in order to allow them to adapt the system to each patients’ needs. 

>patients lost interest in using the system after exploring all the possibilities and features offered 
