...
>the key aim of this study is to conduct a systematic and thematic review on the application of [[Virtual Reality]] in teaching and learning environments of [[ASD]] students during the period 1996–2021. 

1. What type of [[Virtual Reality]] has been used most frequently in research with [[ASD]]
students?
2. What are the research objectives that have been most often worked on for implementing [[Virtual Reality]] for [[ASD]] students?
3. What type of instrument has been the most employed by researchers in their
interventions for [[ASD]] students?
4. What are the characteristics of the activities designed for the intervention of
[[ASD]] students using [[Virtual Reality]] ?
5. What have been the most frequent results achieved in the implementation of [[Virtual Reality]]
for [[ASD]] students?

## Protocol recommendations

>As such, Bozgeyikli et al. (2018) outline some of the features that enhance the use of [[Virtual Reality]] for [[ASD]] people, including: predict- ability, customizable task complexity; control; realism; immersion; automation of feedback, assessment, reinforcement. 
...
>Another of the results to highlight is that in 15.78% (n = 6) of the studies it is observed that [[Virtual Reality]] is very well accepted by [[ASD]] students.

>the vast majority of questionnaires are used for diagnosis and not for the evaluation of improvements 

>children with [[ASD]] find it easier to interpret synthetic and computer-generated devices than natural [[Stimuli]]. 

>the learning of [[ASD]] students will be favored when the user has interaction devices that are as realistic as possible 
...
>the two most frequent research purposes have been: firstly, to develop and teach social skills and secondly, to work on the identification, interpretation, and emotional response of [[ASD]] students 

>it is recommended to use an [[Avatar]] to ask the child what his or her mood is. The child could respond with a series of YES or NO cubes if he/she knows the expression that the avatar is express- ing. The cubes are used so that this activity can be navigated by [[ASD]] students with different levels and input of communication. 

# Synthesis 

This study records every [[Virtual Reality]] and [[ASD]] works from 96 to 2021 and states their domains and recommendations.
